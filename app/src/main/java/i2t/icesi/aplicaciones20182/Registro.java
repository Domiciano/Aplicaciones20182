...
import i2t.icesi.aplicaciones20182.model.Usuario;
...
public class Registro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_nombre = findViewById(R.id.et_user);
    ...
    public void registrarUsuario(final Usuario usuario){
        if(et_pass.getText().toString().length() <= 5){
            Toast.makeText(this, "La contraseña debe ser de longitud 6 o más", Toast.LENGTH_SHORT).show();
            return;
        }

        auth.createUserWithEmailAndPassword(usuario.getEmail(), et_pass.getText().toString())
